...
class DataLoader:
    ...
    def load_currency_codes(self):
        import requests
        import csv
        from io import StringIO
        url = "https://raw.githubusercontent.com/datasets/currency-codes/refs/heads/main/data/codes-all.csv"
        try:
            ...
            for row in reader:
                if row['NumericCode'] and not row['WithdrawalDate']:  # Only active currencies
                    self.currency_codes[row['NumericCode']] = row['AlphabeticCode']
            
        except Exception as e:
            # Fall back to basic currency mapping
            self.currency_codes = {
                "376": "ILS",
                "840": "USD",
                "978": "EUR"
    ...
    def load_mcc_categories(self):
        import requests
        import csv
        from io import StringIO
        url = "https://raw.githubusercontent.com/greggles/mcc-codes/refs/heads/main/mcc_codes.csv"
        try:
            response = requests.get(url)
            response.raise_for_status()
            ...
            reader = csv.DictReader(StringIO(response.text))
            for row in reader:
                self.mcc_categories[row['mcc']] = row['edited_description']
            
        except Exception as e:
            # Fall back to basic MCC mapping
            self.mcc_categories = {
                "5411": "Groceries",
                "5814": "Restaurants"
            }

CURRENCY_CODE_SYMBOL_MAPPING = {
    "AED": "د.إ",
    "؋": "AFN",
    "L": "ALL",
    "֏": "AMD",
...
MCC_EXPENSE_CATEGORIES = {
    "0742": "Expenses:Pets:Vet Visits",
    "0763": "Expenses:Groceries:Farmers Market",
    "0780": "Expenses:Housing:Maintenance",
    "1520": "Expenses:Housing:Maintenance",
    "1711": "Expenses:Housing:Utilities:Electricity",
    "1731": "Expenses:Housing:Utilities:Electricity",
    "1740": "Expenses:Housing:Maintenance",
    "1750": "Expenses:Housing:Maintenance",
    "1761": "Expenses:Housing:Maintenance",
    "1771": "Expenses:Housing:Maintenance",
    "1799": "Expenses:Housing:Maintenance",
    "2741": "Expenses:Miscellaneous:Subscriptions",
    "2791": "Expenses:Miscellaneous:Subscriptions",
    "2842": "Expenses:Groceries:Specialty Stores",
    "3000": "Expenses:Transportation:Air Travel",
    "3001": "Expenses:Transportation:Air Travel",
    "3002": "Expenses:Transportation:Air Travel",
    "3003": "Expenses:Transportation:Air Travel",
    "3004": "Expenses:Transportation:Air Travel",
    # Airlines (3000-3199)
    **{str(code): "Expenses:Transportation:Air Travel" for code in range(3000, 3200)},
    # Car Rentals (3351-3439)
    **{str(code): "Expenses:Transportation:Car Rentals" for code in range(3351, 3440)},
    # Hotels (3501-3790)
    **{str(code): "Expenses:Travel:Hotels" for code in range(3501, 3791)},
    "3816": "Expenses:Travel:Hotels",
    # Public Transportation (4111-4789)
    **{str(code): "Expenses:Transportation:Public Transit" for code in range(4111, 4790)},
    "4812": "Expenses:Utilities:Internet",
    "4814": "Expenses:Utilities:Internet",
    "4900": "Expenses:Housing:Utilities",
    # Groceries and Specialty Food Stores (5411-5499)
    **{str(code): "Expenses:Groceries:Supermarket" for code in range(5411, 5500)},
    # Automotive (5511-5599)
    **{str(code): "Expenses:Transportation:Repairs & Maintenance" for code in range(5511, 5600)},
    # Apparel (5611-5699)
    **{str(code): "Expenses:Personal Care:Clothing" for code in range(5611, 5700)},
    # Furniture and Electronics (5712-5735)
    **{str(code): "Expenses:Entertainment:Electronics" for code in range(5712, 5736)},
    # Dining and Restaurants (5811-5818)
    **{str(code): "Expenses:Dining:Restaurants" for code in range(5811, 5815)},
    "5815": "Expenses:Entertainment:Digital Goods",
    "5816": "Expenses:Entertainment:Digital Goods",
    "5912": "Expenses:Health:Prescriptions",
    "5921": "Expenses:Dining:Alcohol",
    # Entertainment and Recreation (7832-7999)
    **{str(code): "Expenses:Entertainment:Recreation" for code in range(7832, 8000)},
    "8011": "Expenses:Health:Doctor Visits",
    "8021": "Expenses:Health:Dental Care",
    "8042": "Expenses:Health:Vision Care",
    "8111": "Expenses:Miscellaneous:Legal Services",
    # Education (8211-8299)
    **{str(code): "Expenses:Education:Tuition" for code in range(8211, 8300)},
    "8351": "Expenses:Children:Childcare",
    "8398": "Expenses:Miscellaneous:Charity",
    "8651": "Expenses:Miscellaneous:Political Donations",
    # Taxes (9211-9405)
    **{str(code): "Expenses:Taxes:Government Fees" for code in range(9211, 9410)},
}
